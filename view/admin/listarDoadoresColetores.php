...
<!DOCTYPE html>
<!--
PAGINA DE PESQUISA FILTRADA POR OUTROS USUARIOS DO SISTEMA
!-->
<html>
    <head>
        <meta charset="UTF-8">
        ...
        <section>
            ...
            <div align='center'>
                <form name="formPesquisa" action="" method="post">
                    <p>Pesquisar por</p><br><br>
                    <table  name="t1" class="aluno">  
                        <tr>
                    ...
                    if (!empty($_POST['acao']) and !empty($_POST['uf']) and !empty($_POST['cidade']) and !empty($_POST['opcao'])) {
                        ...
                        if (!empty($result)) {
                            ...
                            $msg = 'não foram encontrados resultados para essa busca, verifique '
                                    . 'se todos os campos estão selecionados ou  tente a busca sem filtros presonalzados';
                            echo $msg;
                        }
